    ...
    function header_scroll(header_position, header_height) {
        $(window).on('scroll load', function(event) {
            ...
            if (scroll > header_height) {
                $('.header-sticky').addClass('background_white');
                $('.first-logo').css("display","none");
                $('.second-logo').css("display","block");
                $('.nav-action a').css("color","black");
                $('.header-sticky').addClass('is-sticky');
                $('.trans').removeClass('.trans-header');
                $('.navUser-action .icon').css("fill","black")
                $('.cart-icon').css("color","black")
              // $('body').css('padding-top', header_height);
                $('.search-form-wrapper').addClass('custom');
            } else {
               $('.header-sticky').removeClass('background_white');
               $('.header-sticky').removeClass('is-sticky');
               $('.trans').addClass('.trans-header')
               $('.cart-icon').css("color","white")
               $('.navUser-action .icon').css("fill","white")
               $('.first-logo').css("display","block");
               $('.second-logo').css("display","none");
               $('.nav-action a').css("color","white");
...
$(".answer").each(function(){
 var answerNum = `#answer${counter}`;
 $(".answer").css("display","none");
 $(answerNum).css("display","block")
})
 })
...
$('.reccommend-slider').on('afterChange', function(event, slick, currentSlide, nextSlide){
    var currentSlide = $('.reccommend-slider').slick('slickCurrentSlide');
...
$(".reccommend-slider").slick(
    {
     ...
     prevArrow: '<div class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 33"><g id="7f9a1925-e8c7-4614-8787-3c6095a9f6e1" data-name="Layer 2"><g id="c9b7920a-81fa-4bfe-ad13-4da717c6854b" data-name="Layer 1"><g id="c2d982ff-0cf6-4220-b365-47f30d708fea" data-name="e4eb89a6-f885-43b8-9259-0d6b1516fab0"><g id="f51d455e-6b9c-4c4e-96db-a5004582beda" data-name="8e584754-6657-46f1-a9d8-2cfd6623b552"><polygon points="0 16.5 2.1 18.5 17 33 17 29.3 5.9 18.5 3.8 16.5 5.9 14.5 17 3.7 17 0 2.1 14.5 0 16.5"></polygon></g></g></g></g></svg></div>',
     nextArrow: '<div class = "slick-next"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 17 33" xml:space="preserve"><g id="e4eb89a6-f885-43b8-9259-0d6b1516fab0"><g id="_x38_e584754-6657-46f1-a9d8-2cfd6623b552"><g><polygon points="14.9,14.5 0,0 0,3.7 11.1,14.5 13.2,16.5 11.1,18.5 0,29.3 0,33 14.9,18.5 17,16.5 "></polygon></g></g></g></svg></div>',
     responsive: [
        {
          breakpoint: 1024,
          settings: {
